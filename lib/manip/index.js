...
module.exports = exports = function () {
  var self = this
  return imageMagickInstalled(this.config.convertPath)
    .then(function (is) {
      if (is) {
        throw new Error('Not Implemented')
      } else {
        return Promise.all(self.config.manip.map(function (item) {
    ...
    .then(function () {
      return new Promise(function (resolve, reject) {
        ...
        var req = http.request(reqOptions, function (res) {
          ...
          var separator = ''
          var dst
          var prefix = options.separatorPrefix
          var suffix = options.separatorSuffix
