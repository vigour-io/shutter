...
Shutter.prototype.start = function () {
  ...
  if (this.config.clean.val) {
    ...
    this.config.separatorPrefixBuf = { val: new Buffer(this.config.separatorPrefix.val) }
    this.config.separatorSuffix = { val: ';content:' }
    this.config.separatorSuffixBuf = { val: new Buffer(this.config.separatorSuffix.val) }
    this.config.separatorErrorSuffix = { val: ':error' }
    this.config.separatorErrorSuffixBuf = { val: new Buffer(this.config.separatorErrorSuffix.val) }
  }
